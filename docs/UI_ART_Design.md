...
### 5.1 Menú principal
Refugio temporal: sala destruida con mesa de trabajo. Sobre una **carpeta gris con sello "CONFIDENTIAL" en rojo** aparecen **notas adhesivas** amarillas como botones: **JUGAR / OPCIONES / SALIR**. Props: kit de primeros auxilios abierto, bidón de alcohol, escombros, ventana rota. Interacción: apuntar+seleccionar con controlador VR.
...
> Todo lo anterior que aún no exista como asset final debe montarse como **placeholder** (primitiva + color plano) siguiendo `Contexto.md §6` y registrarse en `Elementos_Faltantes.md`.
