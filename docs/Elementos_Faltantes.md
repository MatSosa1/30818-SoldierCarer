...
| PH-008 | Escenario E2 (Edificio) | Escenario + props | `views/Mision.tscn` → nodo `Escenario_E2_Edificio` (creado en S2, solo plumbing de navegación) | **[S2]** `Node3D` contenedor activable/desactivable con `PlaneMesh` de piso (mismo mesh que E1) y `Marker3D PuntoDespliegue`, sin heridos ni props — únicamente demuestra el cambio de escenario funcional (RF-09) | Sala rectangular, muebles volcados, vidrios, puertas, escalera, papeleo (reutilizar props de E1 donde aplique) | S7 | — | Pendiente |
